...
const Register = () => {
    ...
    const { register, googleLogin, isAuthenticated, user } = useContext(AuthContext);
            ...
            <div style={styles.formSection} className="form-section">
                <div style={styles.card}>
                    <div style={styles.header}>
                        <h1 style={styles.welcomeTitle}>REGISTER WITH US!</h1>
                        <p style={styles.welcomeSubtitle}>Join our community and start your career today.</p>
                    </div>
